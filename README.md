...
- **SAE-idiomatic argument naming**: arguments named after SAE concepts (`auxiliary`, `group`, `sampling_var`, `n`, `deff`)
...
- **Interactive Shiny application**: bilingual (English/Indonesian) GUI via `run_sae_app()`
