...
(the flexible registry-aware factory).
...
Both priors are **cross-cutting** – they work with any family (Gaussian,
Beta, binomial, lognormal, custom…) and combine with splines / GPs
without extra setup.
